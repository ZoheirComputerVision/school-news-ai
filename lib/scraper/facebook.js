...
class FacebookCollector {
  ...
  _demoFallback(limit) {
    if (limit <= 0) return [];
    const samples = [
      { title: 'تنظيم يوم إعلامي حول التوجيه المدرسي', body: 'نظمت ثانوية المجاهد خليل محمد - عين كرمس تيارت، يومًا إعلاميًا حول التوجيه المدرسي لفائدة تلاميذ السنة الثالثة ثانوي.', sourceUrl: '', eventDate: '', imageUrl: '', rawSource: 'facebook' },
      { title: 'إعلان عن تنظيم أيام الأبواب المفتوحة', body: 'تنظم إدارة ثانوية المجاهد خليل محمد - عين كرمس تيارت، أيام الأبواب المفتوحة لفائدة تلاميذ السنة الرابعة متوسط.', sourceUrl: '', eventDate: '', imageUrl: '', rawSource: 'facebook' },
    ];
